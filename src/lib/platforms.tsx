...
export const platformDefinitions: Platform[] = [
  { 
    id: 'pinterest', 
    name: 'Pinterest', 
    icon: (
...
// Helper function to get platforms with enabled state
export const getPlatformsWithState = (enabledPlatforms: string[] = []): Platform[] => {
