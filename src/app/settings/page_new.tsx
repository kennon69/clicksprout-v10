        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
              {/* ClickSprout Status Dashboard */}
              <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 mb-6">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">🚀 ClickSprout Status</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {/* AI Features Status */}
                  <div className="flex items-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${settings.apiKeys.openai ? 'bg-green-500' : 'bg-red-500'}`}></div>
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">AI Content Generation</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        {settings.apiKeys.openai ? 'Ready' : 'OpenAI API key required'}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${
                      settings.apiKeys.supabase.url && settings.apiKeys.supabase.anonKey ? 'bg-green-500' : 'bg-yellow-500'
                    }`}></div>
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">Data Storage</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        {settings.apiKeys.supabase.url && settings.apiKeys.supabase.anonKey 
                          ? 'Supabase configured' 
                  ...
                  <div className="flex items-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${
                      settings.profile.name && settings.profile.email ? 'bg-green-500' : 'bg-yellow-500'
                    }`}></div>
                    <div>
                      <div className="font-medium text-gray-900 dark:text-white">Profile Setup</div>
                      <div className="text-sm text-gray-500 dark:text-gray-400">
                        {settings.profile.name && settings.profile.email ? 'Complete' : 'Partial setup'}
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Button
                          ...
                          disabled={testingConnection.supabase || (!settings.apiKeys.supabase.url && !settings.apiKeys.supabase.anonKey)}
                        >
